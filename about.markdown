...
From the founding of the working group in 2020, we have praticed the art of channeling in different circles we have organized. Two of the founding members, instructor Dr. Stephen Tyman and student Jeremy Weiland, were part of L/L Research's 2016 Channeling Intensive circle and left due to concerns with the administration of the organization. As a result, the circles we have organized are as much a part of the lineage of Confederation channeling as L/L Research's current channeling circles or other historical sites of contact. We train new instruments using the protocols laid down by Carla Rueckert, conveying the vibration of Confederation contacts carefully to preserve the philosophical approach and traditional connection for future generations of seekers. We publish messages we receive at the [High Altitude Receiving Center (HARC)](https://har.center) which gives the reader access to audio recordings and edited transcripts carefully vetted for polarity and accuracy across several circles.

Other offerings include technical resources for helping seekers organize their own working groups—be they for simple meditation, Law of One study, mutual aid, or even eventual channeling. Through our [socialmemorycomplex.earth](https://socialmemorycomplex.earth) project we provide hosting, software, and guidance for seekers looking to find cameraderie with others like themselves, we help new working groups find their center and become independent projects. Additionally, we launched [First Distortion Press](https://firstdistortion.press) in 2024 to publish books on Confederation philosophy, and we maintain a [YouTube channel](https://youtube.com/@oswg) with helpful videos on various Law of One topics. Weiland also podcasts about applying Confederation philosophy to human life at _[(inaudible)](https://inaudible.show)_
...
1. We have a working knowledge of the Law of One philosophy.
1. We have a personal, ongoing practice designed to effect the discipline of the personality.
1. We are willing to be vulnerable to each other and assist one another with respect for our individual paths.
1. We make the sacrifices necessary to show up to at least 75% of online meetings.
1. We commit to meet in person at least once a year, and we will pool resources to make everybody can attend. 

The working group is a tight knit, intimate family of seekers, and we do not solicit members any longer. We cannot say if you're a fit for us, but we do want to make sure you have somebody to talk to and the resources to find the seekers who are right for you. Reach out to Jeremy Weiland by emailing him: the address is `<his first name>@<this website's domain>`. 

We leave you with this concept from Q’uo:
...
> 
> -- <cite>[Q’uo, June 19, 1988](https://www.llresearch.org/channeling/1988/0629)</cite>
